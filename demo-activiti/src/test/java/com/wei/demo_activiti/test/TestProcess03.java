...
public class TestProcess03 {
    ...
    public void testDeployment() {
        ...
        Deployment deployment = repositoryService.createDeployment()
                ...
                .addClasspathResource("process/process03.png")
                .deploy();
    ...
    public void testStartProcess() {
        ...
        ProcessInstance instance = runtimeService.startProcessInstanceByKey("process03", vars);
    ...
    public void testDeleteProcess() {
        ...
        repositoryService.deleteDeployment("15001", true); // 存在未结束流程，关联删除
    }
